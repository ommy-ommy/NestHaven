...
import { LayoutDashboard, Users, Building2, Flag, Settings, Home, TrendingUp, Eye, UserCheck, DollarSign, BarChart3, FileCheck, ShieldCheck } from 'lucide-react'
import './Admin.css'
...
function AdminLayout({ children }) {
  ...
  const links = [
    ...
    { path: '/admin/verification', icon: <ShieldCheck size={18} />, label: 'Property Badges' },
